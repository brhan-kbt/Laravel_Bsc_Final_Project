...
class PromiseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('financeAdmin.promise_mgt.index')->with('promises', $promises)->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function create()
    {
        ...
        return view('financeAdmin.promise_mgt.create')->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function edit($id)
    {
        ...
        return view('financeAdmin.promise_mgt.edit')->with('promise',$promise)->with('messages', $messages)->with('notifications', $notifications);
    }
