...
class OfferingController extends Controller
{
 ...
 public function __construct()
    ...
    public function index()
    {
        ...
        return view('financeAdmin.offering_mgt.index')->with('offerings', $offering)->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function create()
    {
        ...
        return view('financeAdmin.offering_mgt.create')->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function edit($id)
    {
        ...
        return view('financeAdmin.offering_mgt.edit')->with('offering', $offering)->with('messages',$messages)->with('notifications', $notifications);
    }
