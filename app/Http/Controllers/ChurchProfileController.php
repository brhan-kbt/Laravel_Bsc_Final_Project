...
class ChurchProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pradmin.church_profile.churchProfile')->with('posts',$posts)->with('messages', $messages)->with('notifications', $notifications);
    ...
    public function create()
    {
        $messages=$this->getAllMessage();
        $notifications=$this->getNotifications();
        return view('pradmin.church_profile.createProfile')->with('messages',$messages)->with('notifications', $notifications);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pradmin.church_profile.editprofile')->with('posts',$posts)->with('messages',$messages)->with('notifications', $notifications);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $posts->save();
        return redirect('/pradmin/church_profile')->with('success', 'Church profile Updated!');
