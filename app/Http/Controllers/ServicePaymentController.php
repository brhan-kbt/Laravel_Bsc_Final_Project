...
class ServicePaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('financeAdmin.servicePayment_mgt.index')->with('servicePayments', $servicePayments)->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function create()
    {
        ...
        return view('financeAdmin.servicePayment_mgt.create')->with('messages', $messages)->with('notifications', $notifications);
    }
    ...
    public function edit($id)
    {
        ...
        return view('financeAdmin.servicePayment_mgt.edit')->with('servicePayment', $servicePayment)->with('messages', $messages)->with('notifications', $notifications);
    }
