...
@foreach($posts as $post)
    <div class="row">
        <div class="col-12">
            <h1 class="m-2 font-weight-bold">Title:  {{$post->title}}</h1>
        </div>
        <div class="col-sm-6 m-1">
            <img style="width:100%; height:350px;"src="/storage/post_images/{{$post->post_image}}" >
        </div>
        <div class="col-sm-4 m-3">
            ...
            <div class="m-1">
                <p class="ml-5">
                    <a href="{{route('editPost',['id'=>$post->id])}}" class="btn btn-outline-info">Edit </a> 
                </p>  
