...
<main class="">
    <div class="container row_width">
        ...
        <div class="row ">
            <div class="col-sm-6 first_column  mt-3" style="font-weight: bold">
                 <div class="row mb-2">
               ...
               <div class="row">
                    <div class="col-12">
                       <h4><i class="fa fa-map-marker text-info ml-3 mr-3" aria-hidden="true"></i>Address.</h4>
                    </div>
                    <div class="col-12 offset-1">
                      <p class="fa fa-arrow-right">   Ethiopia, Addis Ababa, 6 Kilo</p>
                    </div>
                </div>

                <div class="row">
                    <div class="col-12">
                       <h4><i class="fa fa-phone text-info ml-3 mr-3"></i>Call Us.</h4>
                    </div>

                    <div class="col-12 offset-1">
                        <p class="fa fa-arrow-right">  251-905-2802-74</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                       <h4> <i class="fa fa-mail-bulk text-info ml-3 mr-3"></i>Email Us.</h4>
                    </div>
                     <div class="col-12 offset-1">
                        <p  class="fa fa-arrow-right">  berhanukebito@gmail.com</p>
                        
                     </div>
                </div>
          
        </div>
        <div class="col-sm-6 second_column  edit_contact mb-10">
                <div class="row mt-3">
                    <div class="row mb-2">
                        <h2 class="text-center mt-3 fw-bold text-white">Send Us a Message!</h2>
              ...
              <form action="{{action('MessageController@store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row" style="margin: 20px">
                        <div class="form-group col-12">
                            <div class="row mb-2">
                                <label class="text-white" for="senderName">Full Name</label>
                            </div>
                        ...
                        <div class="form-group col-12 mb-3">
                            <div class="row mb-2">
                                <label class="text-white" for="email">Email or Phone Number</label>
                            </div>
                       ...
                       <div class="form-group col-12">
                            <div class="row mb-2">
                                <label class="text-white" for="title">Subject</label>
                            </div>
                            <div class="row offset-1 mb-3">
                       ...
                       <div>
                            <button type="submit" class="btn btn-primary float-left">Save Change</button>
                        </div>
