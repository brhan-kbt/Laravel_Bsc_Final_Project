    ...
    <div class="row reg-row justify-content-center">
        <div class="col-md-12">
            <div class="card mt-20">
                <div class="card-header fw-bold text-center">Edit Member Information</div>
                  ...
                  <form action="{{action('MemberController@update',$member->id)}}" class="fw-bold" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4 mb-3">
                                ...
                                <input type="file" name="profileImg" class="form-control-file @error('profileImg') is-invalid @enderror" value="{{ $member->profileImg }}"  autocomplete="profileImg" autofocus id="profileImg" >
...
{{-- 
              ...
              {{-- <div class="badge bg-info text-wrap h4 text-dark text-left mb-3 fw-bold font-italic text-decoration-underline">1. Fill Profile Information Below</div> --}}
                ...
                <div class="pt-4 text-center">                  
                    <button type="submit" class="float-right btn-primary btn-lg h-20">Save Change</button>
                </div>
