...
Route::get('/pradmin/notify', 'NotificationController@notify')->name('notify');
...
Route::get('/changeStatus','MemberController@changeStatus')->name('changeStatus');
...
Route::get('/admin/report','AdminController@report')->name('report')->middleware('super');
Route::get('/admin/report/memberReport','AdminController@memberReport')->name('memberReport')->middleware('super');
Route::get('/admin/report/financeReport','AdminController@financeReport')->name('financeReport')->middleware('super');
Route::get('/admin/report/managersReport','AdminController@managersReport')->name('managersReport')->middleware('super');


Route::get('/admin/report/financeReport/tithe','AdminController@titheReport')->name('titheReport')->middleware('super');
Route::get('/admin/report/financeReport/offering','AdminController@offeringReport')->name('offeringReport')->middleware('super');
Route::get('/admin/report/financeReport/promise','AdminController@promiseReport')->name('promiseReport')->middleware('super');
Route::get('/admin/report/financeReport/service','AdminController@serviceReport')->name('serviceReport')->middleware('super');
